...
const Header = () => {
  ...
  return (
    <div className="flex items-center justify-between  bg-slate-600 text-white px-4 py-3">
      ...
      <div className="flex items-center gap-5">
        ...
        <div
          ...
          className=" bg-slate-600 w-10 h-10 rounded-full flex items-center justify-center cursor-pointer"
        >
          <MdPostAdd size={24} />
        </div>
      </div>
